...
programming_languages_options = [
    "Apache Groovy", "Assembly Script", "C", "C++", "C#", "Clojure", "Crystal", "CSS3", "Dart", "Dgraph", "Elixir", "ELM", "ERLANG", "Fortan", "Go/Golang", "GraphQL", "Haskell", "HTML5", "JAVA", "Javascript", "Julia", "Kotlin", "Latex", "LUA", "MARKDOWN", "NIM", "NIX", "Objective-C", "OCAML", "OCTAVE", "ORG MODE", "PERL", "PHP", "POWESHELL", "PYTHON", "R", "RESCRIPT", "RUBY", "RUST", "SCALA", "BASH SCRIPT", "SOLIDITY", "SWIFT", "TYPESCRIPT", "WINDOS TERMINAL", "ZIG"
]

tools_techstack_options = [
    "Alibaba Cloud", "AWS", "AZURE", "CLODFARE", "CODEBERG", "DATADOG", "FIREBASE", "GLITCH", "GOOGLE CLOUD", "HEROKU", "NETLIFY", "ORACLE", "VERCEL", "RENDER", ".NET", "ANACONDA", "ANGULAR", "APACHE SPARK", "APACHE KAFKA", "APACHE HADOOP", "APACHE HIVE", "BOOTSTRAP", "CHART.JS", "CUDA", "DJANGO", "DJANGOREST", "ELECTRON.JS", "EXPRESS.JS", "FASTAPI", "FLASK", "FLUTTER", "LARAVEL", "NPM", "NEST.JS", "NEXT.JS", "NODE.JS", "OPENCV", "OPENGL", "REACT NATIVE", "REACT QUERY", "REACT ROUTER", "REACT", "SASS", "SPRING", "TAILWIND CSS", "VUE.JS", "YARN", "WORDPRESS", "APACHE MAVEN", "APACHE FLINK", "AMAZON DYNAMODB", "CASSANDRA", "FIREBASE", "REDIS", "SQLITE", "ADOBE", "ADOBE AFTER EFFECTS", "ADOBE ILLUSTRATOR", "ADOBE PHOTOSHOP", "BLENDER", "CANVA", "FIGMA", "KERAS", "MATPLOTLIB", "MLFLOW", "NUMPY", "PANDAS", "PLOTLY", "PYTORCH", "SCIKIT-LEARN", "SCIPY", "TENSORFLOW", "GIT", "GITHUB", "GITLAB", "CISCO", "DOCKER", "KUBERNETES", "META", "NOTION", "POSTMAN", "POWER BI", "PREZI", "RASPBERRY PI", "TOR"
]
